    ...
    <>
      <section id="contacts" className="w-full">
        ...
        <div className="max-w-[800px] px-10 my-20 mx-auto">
          <div className="flex flex-col sm:grid sm:grid-rows-2 gap-20 justify-center ml-[20%] sm:ml-0">
            <div className="flex flex-col sm:grid sm:grid-cols-2 gap-20">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[1.2rem] md:text-[1.4rem]">(415) 517-6805</p>
              </div>
            </div>
            <div className="flex flex-col sm:grid sm:grid-cols-2 gap-20">
              <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[1.2rem] md:text-[1.4rem]">_JACKLIU_</p>
              </div>
            </div>
          </div>
        </div>
